...
/*    public static String baseurl="https://myngrewards.com/plugins/webservice/";*/
      public static String baseurl="https://myngrewards.com/wp-content/plugins/webservice/";

    /*https://myngrewards.com/wp-content/plugins/webservice/update_item_status.php?id=*/
...
/*   //TODO: =========testing stripe data===============
    ...
    public static String STRIPE_OAUTH_URL="https://connect.stripe.com/express/oauth/authorize?redirect_uri=https://myngrewards.com/wp-content/plugins/webservice/stripe_payment_form.php&client_id=ca_DtpgsTKByfhAwa5P8oYfWT2CXNXaCnTq&scope=read_write&always_prompt=false&stripe_landing=register&state=";
   public static String STRIPE_OAUTH_URL_MEMBER="https://connect.stripe.com/express/oauth/authorize?redirect_uri=https://myngrewards.com/wp-content/plugins/webservice/stripe_payment_form_member.php&client_id=ca_DtpgsTKByfhAwa5P8oYfWT2CXNXaCnTq&scope=read_write&always_prompt=false&stripe_landing=register&state=";
   */
