...
public class TransferRequestDetActivity extends AppCompatActivity {
    ...
    private String type="",amount_trans_by_card="",comment="",transfer_request_user_id="",user_id="",due_amt_tv_str="",ngcash_str="",tip_str="",business_name="",username="",merchant_contact_name_str = "", merchant_img_str = "", merchant_id_str = "", shipaddress_2_str = "", shipping_name_str = "", cardbrand_str = "", order_id_str = "", merchant_name_str = "", merchant_number_str = "", date_tv_str = "", address_tv_str = "", total_amt_tv_str = "", cardnumber_tv_str = "";
