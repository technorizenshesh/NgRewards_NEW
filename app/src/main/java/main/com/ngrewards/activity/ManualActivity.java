...
public class ManualActivity extends AppCompatActivity {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (object.getString("status").equals("1")) {
                            ...
                            Intent intent = new Intent(ManualActivity.this, OrderPaidSuccesfully.class);
                            intent.putExtra("order_cart_id", order_cart_id);
                            startActivity(intent);
                            finish();

                        } else {
                            Toast.makeText(ManualActivity.this, getResources().getString(R.string.somethingwrong), Toast.LENGTH_LONG).show();
                        }
    ...
    private void fingerPrintLay() {
        final Dialog dialogSts = new Dialog(ManualActivity.this, R.style.DialogSlideAnim);
                ...
                if (!fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    if (!keyguardManager.isKeyguardSecure()) {
                        ...
                        if (cipherInit()) {
                            ...
                            FingerprintHandler helper = new FingerprintHandler(ManualActivity.this, textView, "Payment");
