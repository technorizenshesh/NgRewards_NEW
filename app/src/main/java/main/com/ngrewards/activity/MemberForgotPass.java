        ...
        submit_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email_str == null || email_str.equalsIgnoreCase("")) {
                    Toast.makeText(MemberForgotPass.this, getResources().getString(R.string.enteryouremail), Toast.LENGTH_LONG).show();
                } else {
            ...
            if (result == null) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("1")) {
                        Toast.makeText(MemberForgotPass.this, getResources().getString(R.string.pleaseheck), Toast.LENGTH_LONG).show();
                        finish();
                    } else {
                        Toast.makeText(MemberForgotPass.this, "Your email id is not valid", Toast.LENGTH_LONG).show();
                    }
